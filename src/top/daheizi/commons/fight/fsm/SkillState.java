...
public class SkillState extends AbstractGameState {
    ...
    /**
     * @see top.daheizi.commons.fight.fsm.AbstractGameState#onExit()
     */
    @Override
    public void onExit() {
        // 释放完毕后回调
    ...
    /**
     * @see top.daheizi.commons.fight.fsm.AbstractGameState#handleEvent(top.daheizi.commons.fight.event.FightEvent)
     */
    @Override

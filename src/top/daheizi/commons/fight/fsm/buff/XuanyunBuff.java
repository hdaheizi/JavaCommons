...
public class XuanyunBuff extends CommBuff {
    ...
    /**
     * @see top.daheizi.commons.fight.fsm.buff.CommBuff#onEnter()
     */
    @Override
    public void onEnter() {
        super.onEnter();
    ...
    /**
     * @see top.daheizi.commons.fight.fsm.buff.CommBuff#onExit()
     */
    @Override
    public void onExit() {
        hero.wakeUp();
    ...
    /**
     * @see top.daheizi.commons.fight.fsm.buff.CommBuff#mixBuff(top.daheizi.commons.fight.fsm.buff.Buff)
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.fsm.GameState#update(long)
     */
    @Override

...
import top.daheizi.commons.fight.common.FightFormula;
import top.daheizi.commons.fight.event.BreakEvent;
import top.daheizi.commons.fight.event.BuffEvent;
...
public class CommSkill implements FightSkill {
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#getSkillAttribute()
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#getAttribute(java.lang.String, double)
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#findTargets(java.lang.String)
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#playSkill(int, double)
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#flySkill(int, int)
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#handleEffect(java.lang.String, int)
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#canBeBreak(top.daheizi.commons.fight.event.BreakEvent)
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#onBreak()
     */
    @Override
    public void onBreak() {
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#onOver()
     */
    @Override
    public void onOver() {
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#getSourceHero()
     */
    @Override
    ...
    /**
     * @see top.daheizi.commons.fight.skill.FightSkill#doSkillAttack(top.daheizi.commons.fight.unit.DefaultAIUnit, double, java.lang.StringBuilder)
     */
    @Override

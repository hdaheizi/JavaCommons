...
public class XuanyunBuff extends CommBuff {
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.CommBuff#onEnter()
	 */
	@Override
	public void onEnter() {
		super.onEnter();
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.CommBuff#onExit()
	 */
	@Override
	public void onExit() {
		hero.wakeUp();
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.CommBuff#mixBuff(com.daheiz.base.fight.fsm.buff.Buff)
	 */
	@Override

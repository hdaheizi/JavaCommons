package com.daheiz.base.fight.fsm.buff;

import com.daheiz.base.fight.fsm.AbstractGameState;
...
public abstract class CommBuff extends AbstractGameState implements Buff {
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.Buff#getType()
	 */
	@Override
	public int getType(){
		return this.type;
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.Buff#getPriority()
	 */
	@Override
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.Buff#mixBuff(com.daheiz.base.fight.fsm.buff.Buff)
	 */
	@Override
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.Buff#getSourceSkill()
	 */
	@Override
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.Buff#getSourceHero()
	 */
	@Override
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.Buff#succAttack(com.daheiz.base.fight.unit.DefaultAIUnit, com.daheiz.base.fight.unit.DefaultAIUnit, int, java.lang.StringBuilder, java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see com.daheiz.base.fight.fsm.buff.Buff#calcDam(int, com.daheiz.base.fight.unit.DefaultAIUnit, com.daheiz.base.fight.unit.DefaultAIUnit, int, java.lang.StringBuilder, java.lang.Object)
	 */
	@Override

...
public class SkillState extends AbstractGameState {
	...
	/**
	 * @see com.daheiz.base.fight.fsm.AbstractGameState#onExit()
	 */
	@Override
	public void onExit() {
		// 释放完毕后回调
	...
	/**
	 * @see com.daheiz.base.fight.fsm.AbstractGameState#handleEvent(com.daheiz.base.fight.event.FightEvent)
	 */
	@Override

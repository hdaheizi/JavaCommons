...
public class SkillState extends AbstractGameState {
    ...
    /**
     * @see org.daheiz.base.fight.fsm.AbstractGameState#onExit()
     */
    @Override
    public void onExit() {
        // 释放完毕后回调
    ...
    /**
     * @see org.daheiz.base.fight.fsm.AbstractGameState#handleEvent(org.daheiz.base.fight.event.FightEvent)
     */
    @Override

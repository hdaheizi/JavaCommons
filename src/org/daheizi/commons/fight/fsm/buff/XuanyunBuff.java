...
public class XuanyunBuff extends CommBuff {
    ...
    /**
     * @see org.daheizi.commons.fight.fsm.buff.CommBuff#onEnter()
     */
    @Override
    public void onEnter() {
        super.onEnter();
    ...
    /**
     * @see org.daheizi.commons.fight.fsm.buff.CommBuff#onExit()
     */
    @Override
    public void onExit() {
        hero.wakeUp();
    ...
    /**
     * @see org.daheizi.commons.fight.fsm.buff.CommBuff#mixBuff(org.daheizi.commons.fight.fsm.buff.Buff)
     */
    @Override

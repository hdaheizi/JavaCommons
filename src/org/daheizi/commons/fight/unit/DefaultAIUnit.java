package org.daheizi.commons.fight.unit;
...
import org.daheizi.commons.fight.event.EventAgent;
import org.daheizi.commons.fight.event.EventHandler;
import org.daheizi.commons.fight.event.FightEvent;
import org.daheizi.commons.fight.event.SkillEvent;
import org.daheizi.commons.fight.fsm.GSM;
import org.daheizi.commons.fight.fsm.SkillState;
import org.daheizi.commons.fight.fsm.buff.Buff;
import org.daheizi.commons.fight.fsm.buff.BuffFactory;
import org.daheizi.commons.fight.pot.Pot;
import org.daheizi.commons.fight.room.FightRoom;
import org.daheizi.commons.fight.skill.FightSkill;
import org.daheizi.commons.fight.skill.SkillAttribute;
import org.daheizi.commons.fight.skill.SkillFactory;
import org.daheizi.commons.stl.Tuple;
import org.daheizi.commons.util.MessageFormatter;
import org.daheizi.commons.util.RandomUtil;
...
public abstract class DefaultAIUnit implements EventHandler {
    ...
    /**
     * @see org.daheizi.commons.fight.event.EventHandler#addEvent(org.daheizi.commons.fight.event.FightEvent)
     */
    @Override
    ...
    /**
     * @see org.daheizi.commons.fight.event.EventHandler#handleEvent(org.daheizi.commons.fight.event.FightEvent)
     */
    @Override

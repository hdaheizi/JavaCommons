...
import net.daheizi.commons.test.unit.Book;
import net.daheizi.commons.test.unit.Desk;
import net.daheizi.commons.test.unit.IBook;
import net.daheizi.commons.test.unit.OtherBook;
import net.daheizi.commons.test.unit.OtherDesk;
import net.daheizi.commons.test.unit.RoundDesk;
import net.daheizi.commons.test.util.ProxyHandler;
import net.daheizi.commons.test.util.TypeCounter;

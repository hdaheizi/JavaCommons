package net.daheizi.commons.fight.skill;
...
public class CommSkill implements FightSkill {
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#getSkillAttribute()
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#getAttribute(java.lang.String, double)
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#findTargets(java.lang.String)
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#playSkill(int, double)
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#flySkill(int, int)
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#handleEffect(java.lang.String, int)
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#canBeBreak(net.daheizi.commons.fight.event.BreakEvent)
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#onBreak()
     */
    @Override
    public void onBreak() {
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#onOver()
     */
    @Override
    public void onOver() {
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#getSourceHero()
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.skill.FightSkill#doSkillAttack(net.daheizi.commons.fight.unit.DefaultAIUnit, double, java.lang.StringBuilder)
     */
    @Override

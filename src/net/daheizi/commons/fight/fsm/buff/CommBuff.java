...
import net.daheizi.commons.fight.fsm.AbstractGameState;
...
public abstract class CommBuff extends AbstractGameState implements Buff {
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.buff.Buff#getType()
     */
    @Override
    public int getType(){
        return this.type;
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.buff.Buff#getPriority()
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.buff.Buff#mixBuff(net.daheizi.commons.fight.fsm.buff.Buff)
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.buff.Buff#getSourceSkill()
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.buff.Buff#getSourceHero()
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.buff.Buff#succAttack(net.daheizi.commons.fight.unit.DefaultAIUnit, net.daheizi.commons.fight.unit.DefaultAIUnit, int, java.lang.StringBuilder, java.lang.Object)
     */
    @Override
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.buff.Buff#calcDam(int, net.daheizi.commons.fight.unit.DefaultAIUnit, net.daheizi.commons.fight.unit.DefaultAIUnit, int, java.lang.StringBuilder, java.lang.Object)
     */
    @Override

...
public class SkillState extends AbstractGameState {
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.AbstractGameState#onExit()
     */
    @Override
    public void onExit() {
        // 释放完毕后回调
    ...
    /**
     * @see net.daheizi.commons.fight.fsm.AbstractGameState#handleEvent(net.daheizi.commons.fight.event.FightEvent)
     */
    @Override
